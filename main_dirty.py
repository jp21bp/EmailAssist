...
#### Langgraph embedding models SDK
...
# https://github.com/langchain-ai/langchain-google/blob/main/libs/genai/langchain_google_genai/embeddings.py
...
# print(embedding_model.request_options)
# print(embedding_model.model_config)
# print(embedding_model.model_fields)
...
# # print(dir(client))
# embedding_model = client.models.get(model="gemini-embedding-001")
# # , config=embed_config)
# # print(sample)
# print(dir(embedding_model))
...
# ### Long-term memory
## Sqlite store
# conn = sqlite3.connect("store.sqlite", check_same_thread = False)
...
store.setup()
    # This sets up an embedded col in the database tables equl to the "dims"
        # thus, it's IMPORTANT that the embedded model has dimensions = "dims"
        # if not, the embedded result will be in a different dim than is registered
        # ex: dims = 256 and gemini default dims = 3072 => error

# store.put("random", "hola", "hello")
